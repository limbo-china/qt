...
QT_MOC_LITERAL(10, 90, 8), // "findNext"
QT_MOC_LITERAL(11, 99, 3), // "str"
QT_MOC_LITERAL(12, 103, 19), // "Qt::CaseSensitivity"
QT_MOC_LITERAL(13, 123, 2), // "cs"
QT_MOC_LITERAL(14, 126, 12), // "findPrevious"
QT_MOC_LITERAL(15, 139, 16) // "somethingChanged"

    },
    "Spreadsheet\0modified\0\0cut\0copy\0paste\0"
    "del\0selectCurrentRow\0selectCurrentColumn\0"
    "recalculate\0findNext\0str\0Qt::CaseSensitivity\0"
    "cs\0findPrevious\0somethingChanged"
};
...
void Spreadsheet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 9: _t->findPrevious((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< Qt::CaseSensitivity(*)>(_a[2]))); break;
        case 10: _t->somethingChanged(); break;
        default: ;
        }
        ...
        {
            typedef void (Spreadsheet::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Spreadsheet::modified)) {
                *result = 0;
                return;
            }
        }
