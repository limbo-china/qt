...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ProjectList_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ProjectList_t qt_meta_stringdata_ProjectList = {
    {
QT_MOC_LITERAL(0, 0, 11) // "ProjectList"
...
static const uint qt_meta_data_ProjectList[] = {
...
const QMetaObject ProjectList::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ProjectList.data,
      qt_meta_data_ProjectList,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ProjectList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProjectList.stringdata0))
        return static_cast<void*>(const_cast< ProjectList*>(this));
